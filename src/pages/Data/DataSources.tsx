                    ...
                    <Grid item xs={12} sm={6} key={connector.id}>
                      <Card
                        sx={{
                          ...
                          borderRightColor: (theme) => theme.palette.mode === 'dark' ? 'divider' : alpha(theme.palette.grey[400], 0.5),
                          borderBottomColor: (theme) => theme.palette.mode === 'dark' ? 'divider' : alpha(theme.palette.grey[400], 0.5),
                          borderLeftColor: (theme) => theme.palette.mode === 'dark' ? 'divider' : alpha(theme.palette.grey[400], 0.5),
                          bgcolor: 'background.paper',
                          overflow: 'hidden',
                          position: 'relative',
                          ...
                          '&:hover': {
                            ...
                            borderBottomColor: (theme) => alpha(theme.palette.primary.main, 0.3),
                            borderLeftColor: (theme) => alpha(theme.palette.primary.main, 0.3),
                    ...
                    <Grid item xs={12} sm={6} key={connector.id}>
                      <Card
                        sx={{
                          ...
                          borderRadius: 0,
                          borderTop: '4px solid',
                          borderTopColor: theme => theme.palette.accent.navy,
                          borderRight: '1px solid',
                          borderBottom: '1px solid',
                          borderLeft: '1px solid',
                          borderRightColor: (theme) => theme.palette.mode === 'dark' ? 'divider' : alpha(theme.palette.grey[400], 0.5),
                          ...
                          '&:hover': {
                            ...
                            borderRightColor: (theme) => alpha(theme.palette.accent.navy, 0.3),
                            borderBottomColor: (theme) => alpha(theme.palette.accent.navy, 0.3),
                            borderLeftColor: (theme) => alpha(theme.palette.accent.navy, 0.3),
                            '& .connector-icon-container': {
                              transform: 'scale(1.05)',
